...
2. Access Home Assistant: Open a web browser and go to the IP address. 
  ...
  - `HomeAssitant CLI` :  
      - <img src="./docs/CLI.jpg">
  - `Router's devices list` : 
      - <img src="./docs/RouterList.jpg ">
...
## Customization with EspHome:  <img width="120" height="30" src="./docs/EspHome_Icon.jpg">

**Add Esphome to Home Assistant:** 

- Go to -`Settings > Add-on Store > Search for " Esphome "`
  
<img src="./docs/EspHome_addon.jpg">

- `click install and start add-on`

<img src="./docs/EspHome_addon_Start.jpg">

- `Go to Esphome menu on the left`
  
<img src="./docs/EspHome_Setup.jpg">
...
<img src="./docs/Esp-add_device.jpg">
...
<img width = "650" height = "400" src="./docs/Led_Control.gif">
<img width = "300" height = "400" src="./docs/Led_sample.gif" align = "right">
